...
class CheckoutController extends Controller
{
    ...
    public function add_customer(Request $request)
    {
        ...
        $data = array();
        $data['customer_username'] = $data_r['customer_username'];
        $data['customer_password'] = md5($data_r['customer_password']);
        $data['customer_name'] = $data_r['customer_name'];
        $data['customer_email'] = $data_r['customer_email'];
        $data['customer_phone'] = $data_r['customer_phone'];
