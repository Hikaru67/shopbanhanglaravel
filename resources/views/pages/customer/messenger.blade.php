    ...
    <header>
        ...
        <div class="container">
            ...
            <div class="right">
                ...
                <div class="username">
                    <div class="settings"><img src="{{asset('uploads/settings.svg')}}"></div>Patrcia Fields</div>

                <div class="avatar"><img src="{{asset('uploads/avatar.png')}}"></div>
            ...
            <div class="col-content">
                ...
                <div class="messages">
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status online"></div><img src="{{asset('uploads/avatar-2.png')}}"></div>
                        </div>
                        <h3>Nancy Scott</h3>
                        <p>Be there soon.</p>
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status online"></div><img src="{{asset('uploads/avatar-4.png')}}"></div>
                        </div>
                        <h3>Philip Nelson</h3>
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status online"></div><img src="{{asset('uploads/avatar-5.png')}}"></div>
                        </div>
                        <h3>Theresa Hudson</h3>
                        <p>Goddamn Aliens! &#128514;</p>
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status offline"></div><img src="{{asset('uploads/avatar-4.png')}}"></div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status offline"></div><img src="{{asset('uploads/avatar.png')}}"></div>
                        </div>
                        <h3>Betty Scott</h3>
                        <p>&#128512;</p>
                    ...
                    <li>
                        ...
                        <div class="avatar">
                            <div class="avatar-image">
                                <div class="status online"></div><img src="{{asset('uploads/avatar-3.png')}}"></div>
                        </div>
                        <h3>Philip Nelson</h3>
            ...
            <div class="col-foot">
                ...
                <div class="compose">
                    ...
                    <div class="compose-dock">
                        <div class="dock"><img src="{{asset('uploads/picture.svg')}}"><img src="{{asset('uploads/smile.svg')}}"></div>
                    </div>
        ...
        <div class="col-right">
            ...
            <div class="col-content">
                ...
                <div class="user-panel">
                    ...
                    <div class="avatar">
                        <div class="avatar-image">
                            <div class="status online"></div><img src="{{asset('uploads/avatar.png')}}"></div>
